...
const getUserCard = async (db: Firestore, id: string): Promise<UserCards | null> => {
...
const getAllUserCards = async (db: Firestore): Promise<UserCards[]> => {
...
const getAllEvents = async (db: Firestore): Promise<EventCards[]> => {
...
const getAllBandCards = async (db: Firestore): Promise<BandCards[]> => {
...
const updateUserCard = async (db: Firestore, id: string, updates: Partial<UserCards>) => {
    const docRef = doc(collection(db, COLLECTION_NAME), id);
    try {
...
export { getUserCard, getAllUserCards, getAllEvents, getAllBandCards, updateUserCard };